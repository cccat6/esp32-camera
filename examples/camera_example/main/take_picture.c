...
static camera_config_t camera_config = {
    ...
    .frame_size = FRAMESIZE_QVGA,    //FRAMESIZE_* or custom JPEG frame buffer size in bytes. For ESP32, do not use sizes above QVGA when not JPEG. The performance of the ESP32-S series has improved a lot, but JPEG mode always gives better frame rates.
